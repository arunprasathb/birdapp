...
class BooksTableSeeder extends Seeder {
       ...
       public function run()
       {
         ...
         DB::table('books')->insert(array(
             ...
             array('bookName'=>'Peacock','price'=>'70','shortDescription'=>'any of three species of resplendent birds of the pheasant family, Phasianidae (order Galliformes). Strictly, the male is a peacock, and the female is a peahen; both are peafowl.', 'description'=> 'any of three species of resplendent birds of the pheasant family, Phasianidae (order Galliformes). Strictly, the male is a peacock, and the female is a peahen; both are peafowl. The two most-recognizable species of peafowl are the blue, or Indian, peacock (Pavo cristatus), of India and Sri Lanka, and the green, or Javanese, peacock (P. muticus), found from Myanmar (Burma) to Java. The Congo peacock (Afropavo congensis), which inhabits the forested interior of the Democratic Republic of the Congo, was discovered in 1936 after a search that began in 1913 with the finding of a single feather.', 'imageUrl'=>'https://a-z-animals.com/media/animals/images/470x370/peacock7.jpg', 'paidPdfUrl' => 'https://www.auroville.org/system/file_attachments/files/000/002/359/original/Peacocks.pdf', 'unpaidPdfUrl'=>'')
          ));
       }
