/*! BirdApp app.js
 * ================
 * Main JS application file for BirdApp v2. This file
 * should be included in all pages. It controls some layout
 * options and implements exclusive BirdApp plugins.
 *
 * @Author  Almsaeed Studio
 * @Support <https://www.almsaeedstudio.com>
 * @Email   <abdullah@almsaeedstudio.com>
 * @version 2.4.5
 * @repository git://github.com/almasaeed2010/BirdApp.git
...
if ("undefined" == typeof jQuery) throw new Error("AdminLTE requires jQuery"); + function(a) {
    ...
    $(function () {
	    $('#books-list, #species-list, #users-list, #voice-list, #gallery-list').DataTable({
	      'paging'      : true,
	      'lengthChange': true,
	      'searching'   : true,
	      'ordering'    : true,
    ...
    /*$(document).ready(function(){      
      var postURL = "http://localhost:8000/admin/species/7/store";
      var i=1;  


      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="file" name="imageUrl[]" placeholder="Enter your Name" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
    ...
    $(document).ready(function() {
      ...
      $("body").on("click",".btn-danger",function(){ 
         ...
         tinymce.init({
             ...
             statusbar: false,
             menubar:false,
             toolbar: "undo redo | bold italic underline strikethrough superscript | forecolor | removeformat"
          });
...
function ShowHideDiv() {
    ...
    var image_option = $(".image_option");
    if(color_option.is(':checked')){
        $('.color_field').show();
        $('.image_field').hide();
    }else{
        $('.color_field').hide();
...
function ShowHideDiv1() {
    var color_option = $(".color_option1");
    var image_option = $(".image_option1");
    if(color_option.is(':checked')){
        $('.color_field1').show();
        $('.image_field1').hide();
    }else{
...
function ShowHideDiv2() {
    var color_option = $(".color_option2");
    var image_option = $(".image_option2");
    if(color_option.is(':checked')){
        $('.color_field2').show();
        $('.image_field2').hide();
    }else{
...
function ShowHideDiv3() {
    var color_option = $(".color_option3");
    var image_option = $(".image_option3");
    if(color_option.is(':checked')){
        $('.color_field3').show();
        $('.image_field3').hide();
    }else{
...
function ShowHideDiv4() {
    var color_option = $(".color_option4");
    var image_option = $(".image_option4");
    if(color_option.is(':checked')){
        $('.color_field4').show();
        $('.image_field4').hide();
    }else{
...
/*function ShowHideDiv5() {
    var color_option = $(".color_option5");
    var image_option = $(".image_option5");
    if(color_option.is(':checked')){
        $('.color_field5').show();
        $('.image_field5').hide();
    }else{
